...
const styles = {
  ...
  cubeFace: {
    ...
    cursor: 'pointer',
    'user-select': 'none',
    'background-color': 'var(--openafpm-view-cube-background)',
    color: 'var(--openafpm-view-cube-foreground)',
    border: '2px solid var(--openafpm-view-cube-foreground)',
    '&:hover': {
      'background-color': 'var(--openafpm-view-cube-foreground)',
      color: 'var(--openafpm-view-cube-background)',
      'border-color': 'var(--openafpm-view-cube-background)',
    },
  },
  xPos: {
